...
from typing import NewType, Tuple, Any, Protocol, Optional, Dict
import eth_account
import eth_typing
...
def compile(file_name: str, contract_name: str) -> CompiledContract:
    ...
    raise ValueError(f"Contract {contract_name} not found in {file_name}")
